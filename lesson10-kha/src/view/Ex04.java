	...
	private static void sortArr(String[] strings, int sorttype) {
		Arrays.sort(strings, new Comparator<String>() {
			...
			public int compare(String o1, String o2) {
				//sort type
				//null
				if(o1 == null && o2 != null) return -1 * sorttype;
				if(o2 == null && o1 != null) return 1 * sorttype;
				if(o2 == null && o1 == null) return 0 * sorttype;
				//special
				if("Special".equals(o1) && !"Special".equals(o2)) return 1 * sorttype;
				if(!"Special".equals(o1) && "Special".equals(o2)) return -1 * sorttype;
				if("Special".equals(o1) && "Special".equals(o2)) return 0 * sorttype;
				//string + number
				if(o1.matches("-?\\d+") && !o2.matches("-?\\d+")) return 1 * sorttype;
				if(!o1.matches("-?\\d+") && o2.matches("-?\\d+")) return -1 * sorttype;
				//string
