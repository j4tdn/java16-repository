...
public class App {
	...
	public static void main(String[] args) {
		...
		Customer c2 = new Customer("KH2", "Kate", "243", "Chile");
		...
		Order o1 = new Order(c1,
				...
				LocalDateTime.of(2022, 5, 8, 10, 10, 10));

		Order o2 = new Order(c2, new ItemDetail[] { new ItemDetail(i3, 2), new ItemDetail(i5, 1), },
				LocalDateTime.of(2022, 5, 7, 20, 10, 12));

		Order o3 = new Order(c2, new ItemDetail[] { new ItemDetail(i4, 1) }, LocalDateTime.of(2022, 5, 8, 15, 6, 35));
