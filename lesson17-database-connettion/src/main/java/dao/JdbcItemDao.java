...
public class JdbcItemDao extends AbstractJdbcDao implements ItemDao{
	...
	private static final String STATICSTIC_ITEMS_PER_ITEM_GROUP = ""
	...
	public List<Item> getAll() {
		return getAll(GET_ALL_ITEMS, () -> transformer(rs, transformerItemGroup(rs)));
	}
	...
	public List<Item> getItems() {
		return getElements(
				GET_ALL_ITEMS, 
				() -> transformer(rs, transformerItemGroup(rs)),
				pst -> {});
	}
	
	private static Item transformer(ResultSet rs, ItemGroup ig) {
		Item item = null;
		try {
	...
	@Override
	public List<ItemDto> staticticItemsPerItemGroup() {
		return getElements(STATICSTIC_ITEMS_PER_ITEM_GROUP, 
