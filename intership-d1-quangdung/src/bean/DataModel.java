...
public class DataModel {
	...
	public DataModel(int id, int firstPlaceCounter, int secondPlaceCounter, int thirdPlaceCounter) {
		super();
		this.id = id;
	...
	public String toString() {
		return "DataModel [id=" + id + ", firstPlaceCounter=" + firstPlaceCounter + ", secondPlaceCounter="
