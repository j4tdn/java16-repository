...
public class Ex10ObjectTypeDriff {
	public static void main(String[] args) {
		// String, Integer, Double, Float, Long, Character
		// là kiểu đối tượng, có duy nhất 1 thông tin(thuộc tính) bên trong
		
		// directly assign
		// lưu trữ giá trị ở HEAP -> constant pool(ko thể cập nhật giá trị cuẩ nó ở trên HEAP)
		String s1 = "hello";
		String s2 = "welcome";
		String s3 = "hello";
