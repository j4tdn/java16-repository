...
public class Ex02Random {
	public static void main(String[] args) {
		...
		System.out.println("seconRand: "+ secondRand);
		
		// 3 Random 1 số ngẫu nhiên có giá trị 
		// min100, 101, 102, 103, 104, max105
		// Random(a,b) = a + random(b-a+1)
		int rageRand  = 100 + rd.nextInt(105-100+1);
		System.out.println("rageRand: " + rageRand);
