...
public class Ex06ArrayList_LinkedList {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Add " + COUNT + " elements: LinkedList took " + (System.currentTimeMillis() - start) + "ms");

		System.out.println("==================");
		// Add at index: 0 1000 12000 25000 37000
		for (int i = 0; i < COUNT; i++) {
			alist.add(0, "element # " + i);
		}
		System.out.println("Add at index 0: " + COUNT + " elements: ArrayList took "
				+ (System.currentTimeMillis() - start) + "ms");

		start = System.currentTimeMillis();
		for (int i = 0; i < COUNT; i++) {
			llist.add(0, "element # " + i);
		}
