...
public class Ex06ArrayList_LinkedList {
    ...
    public static void main(String[] args) {
        ...
        int num = 0;
        for (int i = 0; i < COUNT; i++) {
            alist.add(num, "element # " + i);
        }
        System.out.println("Add at index "+ num +" : " + COUNT
                + " elements: ArrayList took "
                + (System.currentTimeMillis() - start) + "ms");

        start = System.currentTimeMillis();
        for (int i = 0; i < COUNT; i++) {
            llist.add(num, "element # " + i);
        }
        System.out.println("Add at index "+ num +" : " + COUNT
        ...
        // Remove 0 12000 25000 37000
        num = 0;
        start = System.currentTimeMillis();
        for (int i = 0; i < COUNT; i++) {
            alist.remove(num);
        }
        System.out.println("Remove element "+ num +" : ArrayList took "
                + (System.currentTimeMillis() - start) + "ms");
        ...
        System.out.println("Remove element "+ num +" : LinkedList took "
                + (System.currentTimeMillis() - start) + "ms");
    }
}
