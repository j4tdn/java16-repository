...
public class Ex02MapInside {
	public static void main(String[] args) {
		...
		// map.put(e5, Arrays.asList(e4, e5)); --> cập nhật lại
		map.put(e6, Arrays.asList(e4, e5));
		
		// map.put(e) --> lấy từng key bên trong map kiểm tra
		// liệu có key.hash nào == e.hash(dựa vào hascode)
		//	 	và key.equals(e) --> không put vào mà chỉ cập nhật value
		// Override hashcode, equals của Employee
