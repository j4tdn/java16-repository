...
/*
 * Constructor reference --> là một cách viết ngắn gọn để tạo ra 1 đối tượng/thể hiện/giá trị cho functional interface
 * 
 ...
 * 
 * --> Functional Interface nào có hàm trừu tượng(Strategy method) có dạng T method_name(....) --> mình có thể dùng lambda hoặc constructor reference để tạo ra đối tượng cho FI đó
 * * */
public class AppleConstructorReference {
	...
	private static void test03(Function<String, Apple> function) {
		...
		Apple apple1 = function.apply("123456");
