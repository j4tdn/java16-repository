...
public class Ex06SortingItemWithShortVersion {
	public static void main(String[] args) {
		...
		// Problem: override Comparable#compareTo(that) --> verbose: ruom ra
		...
		// 1. SORT items by itemId(ASC) --> i1.getitemId() - i2.getitemId()
		// 1. SORT items by name(ASC) --> i1.getName().compareTo(i2.getName())
		...
		ArrayUtils.printf("last --> item by name(ASC)", items);
