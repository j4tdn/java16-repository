...
public class Ex05AvailableSortWithItem {
	public static void main(String[] args) {
		...
		Arrays.sort(items);
		ArrayUtils.prinf("1. Sorting item des by storeId", items);
		...
		ArrayUtils.prinf("2. Sorting item storeId(asc), price(des)", items);
		...
		ArrayUtils.prinf("2. Sorting item name(asc) & null last", items);
	}
