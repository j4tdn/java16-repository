...
public class Ex05BookApp {
	...
	// cau c
	// C1: if(book.getId().startsWith("SGK")
	// C2: book instanceof ClassicalBook
	// C3: book.getClass() == ClassicalBook.class
	...
	private static Book[] initial() {
		return new Book[] { new ClassicalBook("SGKA1", 22d, "Nhi Đồng", true),
				new ClassicalBook("SGKB2", 36, "Lạc Việt", false), new ClassicalBook("SGKC3", 18d, "Nhi Đồng", true),
				new ClassicalBook("SGKD4", 44d, "Nhi Đồng", true),

				new ReferenceBook("STKR1", 66, "Nhi Đồng", 5), new ReferenceBook("STKR1", 88, "Sao Mai", 8),
				new ReferenceBook("STKR1", 77, "Nhi Đồng", 5) };
	}
