...
//			+ "WHERE ig.ID = ?";
	...
	public List<Item> getItems() {
		return getElement(GET_ALL_ITEMS, 
				() -> transformerItem(rs, transformerItemGroup(rs)), pst -> {});
	}
	...
	public List<Item> getItems(LocalDate sellDate) {
		return getElement(GET_ITEMS_BY_ORDER_TIME, 
				() -> transformerItem(rs, null), pst -> {
					try {
	...
	public List<ItemDto> statisticItemsPerItemGroup() {
		return getElement(STATISTIC_ITEMS_PER_ITEM_GROUP,
