...
public class Ex02MapInside {
	...
	private static Map<Employee, List<Employee>> getMap() {
		...
		/*
		 * map.put(e) --> lấy từng key bên trong map kiểm tra liệu có key.háh nào ==
		 * e.hash( dựa vào hashcode) và key.equals(e) --> không put vào
		 * 
		 * Overide hashcode, equals trong class cua e.
		 */
