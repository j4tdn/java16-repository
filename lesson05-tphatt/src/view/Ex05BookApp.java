...
public class Ex05BookApp {
	...
	// Tìm toàn bộ sách có đơn giá nhở hơn 50
	...
	private static Book[] initial() {
		return new Book[] { new ClassicalBook("SGKA1", 22d, "Nhi Dong", true),
				new ClassicalBook("SGKB2", 36d, "Lac Viet", false), new ClassicalBook("SGKC3", 18d, "Nhi Dong", true),
				new ClassicalBook("SGKD4", 44d, "Nhi Dong", true), new ReferenceBook("STKR1", 66d, "Nhi Dong", 5),
				new ReferenceBook("STKR2", 88d, "Sao Mai", 8), new ReferenceBook("STKR3", 88d, "Nhi Dong", 5), };
	}
