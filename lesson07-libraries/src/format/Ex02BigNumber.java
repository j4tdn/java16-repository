...
public class Ex02BigNumber {
	public static void main(String[] args) {
		 ...
		 *
		 * Hỗ trợ 1. Lưu trữ số phạm vi số lơn (không in ra dạng E^x) 2. Hỗ trợ
		 * rounding, scale nhiều hơn 3. Hỗ trợ các hàm tính toán + - * / --> commercial
		 * round
		 */
		BigDecimal value = BigDecimal.valueOf(123456789876543.258).setScale(2, RoundingMode.HALF_UP);
