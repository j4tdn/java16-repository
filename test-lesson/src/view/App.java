...
public class App {
	public static void main(String[] args) {
		...
		Order o1 = new Order(c1, new ItemDetail[] { new ItemDetail(i1, 3), new ItemDetail(i4, 2), new ItemDetail(i5, 5)

		}, LocalDateTime.of(2022, 7, 7, 10, 10, 10));
		Order o2 = new Order(c2, new ItemDetail[] { new ItemDetail(i1, 3), new ItemDetail(i4, 5), new ItemDetail(i2, 2)

		}, LocalDateTime.of(2022, 7, 8, 8, 10, 30));

		Order o3 = new Order(c2, new ItemDetail[] { new ItemDetail(i1, 3), new ItemDetail(i4, 5), new ItemDetail(i2, 2)

		}, LocalDateTime.of(2022, 7, 8, 20, 30, 10));

		System.out.println("Order 1: " + OrderUtils.export(o1));
		System.out.println("Order 2: " + o1);
		System.out.println("Order 3: " + o2);
	}
}
